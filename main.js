...
//YouTube: @voskey001
//Instagram: voskey001
//Telegram: t.me/voskey001
//GitHub: @voskey001
//WhatsApp: +254769079323
//want more free bot scripts? subscribe to my youtube channel: https://youtube.com/@voskey001
...
XeonBotInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
            ...
            console.log(chalk.magenta(`${themeemoji} INSTAGRAM: @voskey `))
            console.log(chalk.magenta(`${themeemoji} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${themeemoji} CREDIT: Voskey`))
        }
        if (
            connection === "close" &&
            lastDisconnect &&
